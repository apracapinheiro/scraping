...
# url = 'http://loja.weconsultoria.com.br/fermentos-s10036/?pagina='  # WE
# url = 'http://www.cervejadacasa.com/loja/catalogo.php?loja=420472&categoria=53&pg=%d' % num_pagina # CERVEJA DA CASA
# url = 'http://cervejacaseira.com.br/materias-primas.html?cat=91&p=%d' %num_pagina  # ARTEBREW
url = 'http://www.bahiamalte.com.br/categoria-produto/maltes/page/%d' % num_pagina
...
gera_csv(lista_insumos, NOME_SITE)